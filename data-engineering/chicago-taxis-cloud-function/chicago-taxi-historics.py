...
## API CALL FUNCTION
def get_data(limit: int = 1000, offset: int = 0):
    #url = "https://data.cityofchicago.org/resource/ajtu-isnz.json?$limit={0}&$offset={1}&$where=trip_start_timestamp>'2024-01-05T00:00:00.000'".format(limit, offset)
    url = "https://data.cityofchicago.org/resource/wrvz-psew.json?$limit={0}&$offset={1}&$where=trip_start_timestamp between '2023-01-01T00:00:00.000' and '2023-02-28T00:00:00.000'".format(limit, offset)
...
def hello_http(request):
    ...
    offset = 0
    while True: 
        data_batch = get_data(limit=limit, offset=offset)
